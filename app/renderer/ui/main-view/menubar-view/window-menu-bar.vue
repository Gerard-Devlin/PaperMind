...
<template>
  ...
  >
    <div class="grow min-w-0 my-auto pl-2 pr-0 nodraggable-item">
      <CommandBar id="command-bar" />
    </div>

    <div
      class="flex flex-none justify-end space-x-1 my-auto nodraggable-item"
      :class="uiState.os !== 'win32' ? 'w-80 pl-8 pr-2' : 'w-[17rem] pl-0 pr-1'"
    >
      <MenuBarBtn
      ...
      <MenuBarBtn
        id="paper-graph-btn"
        btnName="papergraph"
        @event:click="emits('event:click', 'paper-graph')"
        :disabled="uiState.contentType !== 'library'"
        :with-tooltip="false"
      />
      <div
      ...
      <Menu as="div" class="relative inline-block text-left cursor-pointer">
        <div>
          <MenuButton
            id="sort-menu-btn"
            class="inline-flex h-6 min-w-[1.875rem] shrink-0 justify-center rounded-md px-1 hover:bg-neutral-200 hover:dark:bg-neutral-700 cursor-pointer"
          >
            <BIconFilterRight
      ...
      >
        <div>
          <MenuButton
            ...
            class="inline-flex h-6 min-w-[1.875rem] shrink-0 justify-center rounded-md px-1 hover:bg-neutral-200 hover:dark:bg-neutral-700 cursor-default"
          >
            <BIconThreeDots
              class="text-sm m-auto text-neutral-700 dark:text-neutral-300"
            />
