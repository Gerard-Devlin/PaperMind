...
<template>
  ...
  >
    <div
      class="my-auto px-2 flex min-w-0 shrink-0"
    ...
    >
      ...
      <span
        class="my-auto truncate flex min-w-0 w-full"
          ...
          :class="
            downloaded
              ...
              : active
                ...
                : 'bg-red-500'
          "
          v-if="downloaded || !read"
        />
        <span class="my-auto truncate min-w-0" v-html="sanitizeHTML(field.value)"> </span>
      </span>
